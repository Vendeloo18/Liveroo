...
const CATALOGO: [string, string, string, number, number, string, number][] = [
  ...
  ["Control inalámbrico para PlayStation", "Electronica", "photo-1592840496694-26d035b52b48", 8, 1, "seller005", 14],
  ...
  ["Teclado inalámbrico slim", "Electronica", "photo-1587829741301-dc798b83add3", 12, 2, "seller001", 12],
  ["Mouse gamer 16000 DPI", "Electronica", "photo-1527814050087-3793815479db", 6, 1, "seller001", 18],
  ["PC gamer torre con luces RGB", "Electronica", "photo-1587202372775-e229f172b9d7", 20, 5, "seller001", 64],
  ...
  ["Termostato inteligente WiFi", "Hogar", "photo-1558002038-1055907df827", 12, 1, "seller006", 90],
  ["Cámara Canon con lente 50mm", "Electronica", "photo-1516035069371-29a1b244cc32", 25, 5, "seller003", 16],
  ["Cartera de cuero para dama", "Moda y Ropa", "photo-1548036328-c9fa89d128fa", 12, 1, "seller004", 28],
  ...
  ["Tenis Nike Air Max rojos talla 42", "Calzado", "photo-1542291026-7eec264c27ff", 20, 2, "seller009", 24],
  ["Sneakers urbanas edición limitada", "Calzado", "photo-1595950653106-6c9ebd614d3a", 18, 2, "seller009", 42],
  ["Tenis Nike Air Max blancos talla 41", "Calzado", "photo-1600185365483-26d7a4cc7519", 30, 5, "seller009", 70],
  ...
  ["Collar elegante chapado en oro", "Joyas y Relojes", "photo-1611652022419-a9419f74343d", 40, 5, "seller010", 84],
  ["Monitor gamer curvo 27 pulgadas", "Electronica", "photo-1598550476439-6847785fcea6", 25, 5, "seller005", 34],
  ["Café en grano premium 1kg", "Comida", "photo-1517668808822-9ebb02f2a0e6", 8, 1, "seller014", 60],
  ["Jarra de vidrio para jugos", "Hogar", "photo-1585515320310-259814833e62", 6, 1, "seller014", 46],
  ["Cafetera con molino integrado", "Hogar", "photo-1570222094114-d054a817e56b", 18, 2, "seller014", 100],
  ["Leggings deportivos de alto impacto", "Deportes", "photo-1571019613454-1cb2f99b2d8b", 8, 1, "seller008", 38],
  ["Kit de mancuernas ajustables 20kg", "Deportes", "photo-1534438327276-14e5300c3a48", 20, 2, "seller008", 120],
  ["Balón de fútbol profesional #5", "Deportes", "photo-1614632537190-23e4146777db", 7, 1, "seller008", 54],
  ["Cámara instantánea vintage", "Colecciones", "photo-1526170375885-4d8ecf77b99f", 22, 2, "seller011", 96],
  ["Lentes de sol polarizados Ray-Ban", "Moda y Ropa", "photo-1572635196237-14b3f281503f", 14, 1, "seller004", 110],
  ["Casco de moto certificado DOT", "Autos y Motos", "photo-1558981806-ec527fa84c39", 20, 2, "seller013", 140],
  ["Consola Xbox Series S", "Electronica", "photo-1605901309584-818e25960a8f", 10, 5, "seller005", 66],
  ["iPhone 12 64GB excelente estado", "Electronica", "photo-1511707171634-5f897ff02aa9", 12, 5, "seller003", 82],
  ["Laptop ultradelgada 13 pulgadas", "Electronica", "photo-1541807084-5c52b6b3adef", 30, 5, "seller003", 128],
  ["Teclado inalámbrico compacto", "Electronica", "photo-1541140532154-b024d705b90a", 8, 1, "seller001", 106],
  ["Smartwatch pantalla AMOLED", "Electronica", "photo-1579586337278-3befd40fd17a", 12, 1, "seller015", 116],
  ["Parlante Bluetooth de sonido envolvente", "Electronica", "photo-1558537348-c0f8e733989d", 10, 1, "seller015", 132],
  ["Audífonos inalámbricos over-ear", "Electronica", "photo-1583394838336-acd977736f90", 9, 1, "seller015", 148],
  ["Cámara mirrorless compacta", "Electronica", "photo-1452780212940-6f5c0d14d848", 22, 2, "seller003", 96],
  ["Bolso de cuero rojo artesanal", "Moda y Ropa", "photo-1584917865442-de89df76afd3", 14, 1, "seller004", 74],
  ["Tenis deportivos verde neón talla 40", "Calzado", "photo-1606107557195-0e29a4b5b4aa", 16, 2, "seller009", 92],
  ["Reloj de pared minimalista", "Hogar", "photo-1434056886845-dac89ffe9b56", 22, 2, "seller006", 118],
  ["Bicicleta de ruta en aluminio", "Deportes", "photo-1485965120184-e220f721d03e", 40, 5, "seller016", 172],
  ["Cuadro de arte urbano", "Arte", "photo-1547891654-e66ed7ebb968", 15, 2, "seller012", 152],
];
